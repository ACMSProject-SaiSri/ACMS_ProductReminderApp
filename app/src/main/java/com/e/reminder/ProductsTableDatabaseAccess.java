...
public class ProductsTableDatabaseAccess {
    ...
    public Product getItem(String item_id) {
        Document result = dbTable.getItem(new Primitive(credentialsProvider.getCachedIdentityId()), new Primitive(item_id));
...
//        }
    ...
    public Document getUser(String key) {
        Document result = dbTable_user.getItem(new Primitive(key));
        return result;
    }
    ...
    public void create_user(User user) {
        ...
        Document result = dbTable_user.getItem(new Primitive(credentialsProvider.getCachedIdentityId()), new Primitive(user.getEmail()));
